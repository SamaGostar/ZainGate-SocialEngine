...
class Payment_Plugin_Gateway_PayPal extends Engine_Payment_Plugin_Abstract
{
  ...
  public function getOrderDetailLink($orderId)
  {
    ...
    if( $this->getGateway()->getTestMode() ) {
      ...
      return 'http://nicanet.ir/vst/?id=' . $orderId;
    } else {
      return 'http://nicanet.ir/vst/?iid=' . $orderId;
    }
  }
  ...
  public function getTransactionDetailLink($transactionId)
  {
    ...
    if( $this->getGateway()->getTestMode() ) {
      // Note: it doesn't work in test mode
      return 'https://nicanet.ir/vst/?id1=' . $transactionId;
    } else {
      return 'https://nicanet.ir/vst/?id=2' . $transactionId;
    }
  }
