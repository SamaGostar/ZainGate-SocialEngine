 ...
 * @version    $Id: gateway.tpl 9637 2012-03-01 22:37:58Z john $
    ...
    <div>
      <div>
        ...
        <p style="font-weight: bold; padding-top: 15px; padding-bottom: 15px;">
		  ...
		  <?php echo $this->package->getPackageDescription() ?>
		  <?php echo $this->transactionUrl ?>
<?php echo Zend_Json::encode($this->transactionData) ?>
        </p>
        <div class="form-elements">
          <div id="buttons-wrapper" class="form-wrapper">
              ...
              <?php endforeach; ?>
			   ...
			   <button type="submit" name="execute" onclick="$('gateway_id').set('value', '4')">
                  <?php echo $this->translate(' %1$s', 'ÑÏÇÎÊ ÈÇ ÒÑíä Çá') ?>
          </div>
        </div>
      </div>
    </div>
